...
local function smal_help()
	...
	8- ربات رپورت است، برای استفاده از همه ی قابلیتهای آن 10 پیام به پی وی ارسال کنید
	
	9- در لیست کامندها (دستورات) محتویات داخل پرانتز، متغییرها هستند و نباید موقع ارسال دستور نیز از پرانتز استفاده کنید
	______________________________
	Channel: @fucker_Team
	Sudo Admin: @NetHaLL]]
end
